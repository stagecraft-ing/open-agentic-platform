...
export namespace agents {
    ...
    export class ServiceClient {
        ...
        public async createAgent(projectId: string, params: CreateAgentRequest): Promise<CreateAgentResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/api/projects/${encodeURIComponent(projectId)}/agents`, JSON.stringify(params))
        ...
        public async listAgents(projectId: string, params: ListAgentsRequest): Promise<ListAgentsResponse> {
            // Convert our params into the objects we need for the request
            const query = makeRecord<string, string | string[]>({
            ...
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("GET", `/api/projects/${encodeURIComponent(projectId)}/agents`, undefined, {query})
...
export namespace sync {
    ...
    export interface ServerEnvelopeWire {
        kind: "policy.updated" | "grant.updated" | "deploy.status" | "project.updated" | "factory.event" | "factory.run.request" | "agent.catalog.updated" | "agent.catalog.snapshot" | "project.catalog.upsert" | "sync.ack" | "sync.nack" | "sync.resync_required" | "sync.heartbeat" | "sync.hello"
        meta: ServerMeta
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "fullstack-app-37a2-Generated-TS-Client (Encore/v1.56.7)";
        }
