...
export namespace db {
    ...
    export type ArtifactKind = "agent" | "skill" | "process-stage" | "adapter-manifest" | "contract-schema" | "pattern" | "page-type-reference" | "sample-html" | "reference-data" | "invariant" | "pipeline-orchestrator"
...
export namespace sync {
    ...
    export interface ServerEnvelopeWire {
        kind: "policy.updated" | "grant.updated" | "deploy.status" | "project.updated" | "factory.event" | "factory.run.request" | "agent.catalog.updated" | "agent.catalog.snapshot" | "project.agent_binding.updated" | "project.agent_binding.snapshot" | "project.catalog.upsert" | "sync.ack" | "sync.nack" | "sync.resync_required" | "sync.heartbeat" | "sync.hello"
        meta: ServerMeta
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "fullstack-app-37a2-Generated-TS-Client (Encore/v1.57.5)";
        }
