...
[![Specs: 221](https://img.shields.io/badge/specs-221-informational)](specs/)
...
- **Spec spine** — 221 markdown specs compile to a deterministic
...
# Lifecycle inventory across the 221-spec corpus.
# 172 approved, 14 draft, 35 superseded.
...
- **Spec compilation and querying:** 221 specs compile deterministically.
...
|---|---|
| `specs/` | The authoritative spec spine. 221 specs as of 2026-06-21. |
