...
sequence: 5
inputs:
  - .elucid/build-spec.yaml (api section)
  - requirements/sitemap.json
  - requirements/audiences.json
  - requirements/journeys.json
outputs:
  - .elucid/build-spec.yaml (ui section populated — Build Spec now complete)
...
Populate the `ui` and remaining sections (integrations, notifications, audit, traceability) of `.elucid/build-spec.yaml`. After this stage, the Build Specification is **complete**.
