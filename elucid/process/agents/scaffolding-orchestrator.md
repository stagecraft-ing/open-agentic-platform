...
- `.elucid/build-spec.yaml` — complete, frozen Build Specification
- `.elucid/adapter-manifest.yaml` — resolved adapter
- `.elucid/pipeline-state.json` — current pipeline state
...
On startup, read `.elucid/pipeline-state.json`:
