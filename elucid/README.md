...
A generic, modular, technology-agnostic software factory framework. Elucid separates the **process** of building software (requirements, design, specification) from the **implementation details** (frameworks, languages, patterns) by introducing a formal contract layer between them.

## Architecture

Elucid is built on three layers:
