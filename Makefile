...
# the TS side with bun (which handles .ts natively): the knowledge schema
# walks a plain-data `extractionOutputDescriptor` (spec 125, no zod —
# Encore parser invariant); the provenance + stakeholder-doc surfaces
# remain on the zod walker until specs 121 §8 / 122 land their TS mirrors
# (currently in reserved mode).
# ============================================================
...
ci-schema-parity:
	...
	@echo ""
	@echo "==> ci-schema-parity: walk TS schemas (descriptor + zod) and compare"
