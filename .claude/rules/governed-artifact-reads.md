...
| `.derived/codebase-index/index.json` | `codebase-indexer` | `compile`, `check`, `render` (generic L1+L2+Diagnostics, restored in Epic 2 I11), `orphans` (newline ids or `--json` array, added 2026-05-23 by spec 101 self-amendment), `dump-inputs` |
