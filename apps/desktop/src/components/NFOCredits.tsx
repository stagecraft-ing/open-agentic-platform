...
export const NFOCredits: React.FC<NFOCreditsProps> = ({ onClose }) => {
  ...
  const creditsContent = [
    { type: "header", text: "opc v0.2.1" },
    { type: "subheader", text: "[ A STRATEGIC PROJECT ]" },
    { type: "spacer" },
    { type: "section", title: "━━━ CREDITS ━━━" },
    { type: "credit", role: "POWERED BY", name: "Anthropic Claude" },
            ...
            <div className="flex items-center justify-between px-4 py-2 bg-card border-b border-border">
              ...
              <div className="flex items-center space-x-2">
                <Button
                  ...
                  onClick={async (e) => {
                    e.stopPropagation();
                    await openUrl("https://github.com/stagecraft-ing/opc/issues/new");
                  }}
            ...
            <div className="relative h-[calc(100%-40px)] bg-background overflow-hidden">
              ...
              <div className="absolute top-0 left-0 right-0 bg-background z-10 pb-4 text-center">
                <button
                  ...
                  onClick={async (e) => {
                    e.stopPropagation();
                    await openUrl("https://stagecraft.ing");
                  }}
                >
                  <img 
                    src={asteriskLogo} 
