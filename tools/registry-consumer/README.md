...
## Controlled extension mode (Feature 029)

This interface is now in **controlled extension mode**. Existing contract fixtures and tests are normative behavior, not optional snapshots.

Normative surfaces include:

- JSON shape/content/order contracts
- error/exit contracts
- help/version contracts
- argument-validation contracts
- default-path and `--allow-invalid` policy contracts
- stdout/stderr channel contracts

Governance doctrine and reviewer gates:
