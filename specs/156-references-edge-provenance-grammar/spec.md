...
# are stripped (paths deleted). The surviving edges (spec-types overlay, codebase-index
# + registry schemas, featuregraph golden) carry this spec's authority. Amended by 217.
extends:
