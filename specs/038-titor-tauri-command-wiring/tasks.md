...
- [ ] **T001** — Create `TitorState` struct in `commands/titor.rs`
...
- [ ] **T002** — Register `TitorState` in Tauri app setup
...
- [ ] **T003** — Wire `titor_init` to persist instance in `TitorState`
...
- [ ] **T004** — Wire `titor_checkpoint` command
...
- [ ] **T010** — Update `execution/verification.md` with test commands and results
- [ ] **T011** — Run `spec-compiler compile` to update registry
