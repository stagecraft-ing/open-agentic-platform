---
description: "Task list for spec 140 — aim-vue-node manifest cutover to scaffold_source_id"
---
...
- [ ] T076 [P4] Commit + open PR. Title:
      `feat(spec-140): aim-vue-node manifest cutover — scaffold_source_id replaces template_remote`.
