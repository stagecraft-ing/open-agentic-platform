...
- [x] **T010** Create `product/apps/opc/src/components/AgentPicker.tsx`. Props per spec §3. Body is a modal + tabs + search + list. Empty state: "No bindings yet — open the project's Agents tab in stagecraft to bind one."
