...
- `product/apps/opc/src-tauri/src/commands/stagecraft_client.rs` (around L483–L550) — current write surfaces (`ingest_events`, `record_artifacts`); this spec adds three new Tauri commands alongside.
