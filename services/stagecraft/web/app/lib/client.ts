...
export namespace auth {
    ...
    export class ServiceClient {
        ...
        public async adminSession(params: {
    token: string
}): Promise<SessionResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/admin/auth/session`, JSON.stringify(params))
            return await resp.json() as SessionResponse
        }

        public async adminSignin(params: SigninReq): Promise<AuthSigninResponse> {
            // Now make the actual call to the API
            const resp = await this.baseClient.callTypedAPI("POST", `/admin/auth/signin`, JSON.stringify(params))
            return await resp.json() as AuthSigninResponse
        }
    ...
    token: string
        ...
        public async signin(params: SigninReq): Promise<AuthSigninResponse> {
            // Now make the actual call to the API
        ...
        public async signup(params: SignupReq): Promise<AuthSigninResponse> {
            // Now make the actual call to the API
...
class BaseClient {
    ...
    constructor(baseURL: string, options: ClientOptions) {
        ...
        if (!BROWSER) {
            this.headers["User-Agent"] = "fullstack-app-37a2-Generated-TS-Client (Encore/v1.54.0)";
        }
